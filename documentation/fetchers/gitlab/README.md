...
| `GITLAB_INSECURE_CONNECTION` | true          | Is the GitLab host using an insecure certificate? (true/false) |
...
Starts a fetching process for both commit and file data from a GitLab repository. All additional metadata and link data will be included, i.e. true used for all the boolean parameters for commits and files endpoints.
...
Starts a fetching process for both commit and file data from a GitLab repository. All additional metadata and link data will be included.
