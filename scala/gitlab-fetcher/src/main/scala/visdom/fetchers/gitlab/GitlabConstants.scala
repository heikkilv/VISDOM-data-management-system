...
object GitlabConstants {
    ...
    val PathUsers: String = "users"

    // constants for query parameters
    val ParamAction: String = "action"
    val ParamAfter: String = "after"
    val ParamBefore: String = "before"
    ...
    val ParamTargetType: String = "target_type"
    ...
    val AttributeActionType: String = "action_type"
    ...
    val AttributeAuthorUsername: String = "author_username"
    ...
    val AttributeTargetType: String = "target_type"
    ...
    val FetcherTypeEvents: String = "events"
