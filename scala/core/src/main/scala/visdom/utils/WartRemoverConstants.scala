...
object WartRemoverConstants {
    ...
    final val WartsListSize = "com.sksamuel.scapegoat.inspections.collections.ListSize"
    final val WartsMaxParameters = "com.sksamuel.scapegoat.inspections.MaxParameters"
